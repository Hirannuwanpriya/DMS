        ...
        <div class="mt-10">
            ...
            <form action="{{ route('deliveries.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="pickup_address" id="pickup_address" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="pickup_name" id="pickup_name" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('pickup_name')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="text" name="pickup_contact_no" id="pickup_contact_no" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="pickup_email" id="pickup_email" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('pickup_email')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="text" name="delivery_address" id="delivery_address" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="delivery_name" id="delivery_name" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('delivery_name')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="text" name="delivery_contact_no" id="delivery_contact_no" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="delivery_email" id="delivery_email" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="datetime-local" name="pickup_time" id="pickup_time" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('pickup_time')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="datetime-local" name="shipment_ready_time" id="shipment_ready_time" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="package_description" id="package_description" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required></textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="length" id="length" step="0.01" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('length')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="number" name="height" id="height" step="0.01" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('height')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="number" name="width" id="width" step="0.01" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('width')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="number" name="weight" id="weight" step="0.01" class="mt-1 py-2 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('weight')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
